                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
													<div class="form-gruop">
														...
														<div class="col-md-3">
															<label for="name-category">Nombre</label>
															<input type="text" class="form-control" name="name-category" id="name-category" placeholder="Escribe el Nombre de la categoría">
														</div>
														<div class="col-md-3">
														...
														<button type="button" class="btn btn-primary pull-right new-setting-btn" 
															id="itemTextsImageProducts" onclick="addTextName()">
